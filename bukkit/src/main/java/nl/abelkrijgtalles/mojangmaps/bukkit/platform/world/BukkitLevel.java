...
import nl.abelkrijgtalles.mojangmaps.bukkit.platform.util.BukkitConversion;
...
public class BukkitLevel implements Level {

    private final String worldName;

    public BukkitLevel(String worldName) {
    ...
    public int getHeightAtLocation(@NotNull HeightMapType type, int x, int z) {
        ...
        return getWorld().getHighestBlockYAt(x, z, BukkitConversion.heightMapType(type));
    }
